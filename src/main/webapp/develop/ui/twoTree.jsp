...
<%@include file="/WEB-INF/ehr/commons/jsp/commonInclude.jsp" %>
    ...
    <script src="${contextRoot}/develop/lib/jquery/jquery-1.9.1.js" type="text/javascript"></script>
    <link href="${contextRoot}/develop/lib/ligerui/skins/Aqua/css/ligerui-all.css" rel="stylesheet" type="text/css"/>
    <link href="${contextRoot}/develop/lib/plugin/scrollbar/jquery.mCustomScrollbar.css" rel="stylesheet">
    <script src="${contextRoot}/develop/lib/ligerui/core/base.js" type="text/javascript"></script>
    <script src="${contextRoot}/develop/lib/ligerui/plugins/ligerTree.js" type="text/javascript"></script>
    <script src="${contextRoot}/develop/lib/ligerui/plugins/customTree.js" type="text/javascript"></script>
    <script src="${contextRoot}/develop/lib/plugin/scrollbar/jquery.mCustomScrollbar.js" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        function getData() {
            return [{id: "std0", pid: "-1", text: "数据集",ischecked: true},
                {id: "std1", pid: "std0",ischecked: true, text: "数据集数据集数据集数据集数据集数据集数据集数据集数据集数据集数据集数据集数据集数据集数据集1"},
                {id: "std3", pid: "std0", text: "数据集3"},
                {id: "std5", pid: "std1", text: "数据集5",ischecked: true},
...
<div style="margin-left: 30px;">
    ...
    <div style="margin-top: 50px;">数据集名称:<input type="text" id="datasetName"><button id="query_btn">查询</button> </div>
