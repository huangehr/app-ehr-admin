...
<style>
    ...
    .div-header{width: 160px;float: left;height: 100%;border:1px solid #dcdcdc;border-left: 0;background: #EDF6FA;    position: fixed; left: 0px;}
    ...
    .div-right-header{width: calc(100% - 160px);height: calc(100% - 80px);margin-left: 160px;}
    .div-right-empty{height: 608px;border-bottom: 1px solid #dcdcdc;}
    ...
    .div-btn-group{margin: 0 auto;width: 480px;padding-top: 20px;}
    ...
    .add-choice {
        background: url(${staticRoot}/images/tianjia_icon.png) no-repeat;
        cursor: pointer
    }

    .batch-add-choice {
        background: url(${staticRoot}/images/piliangtianjia_icon.png) no-repeat;
        background-position: -5px 0;
        cursor: pointer
    }

    .question-instruction {
        background: url(${staticRoot}/images/shuoming_icon.png) no-repeat;
        background-position: 6px 0
    }

    .question-transform {
        background: url(${staticRoot}/images/zhuanhuan_icon.png) no-repeat;
        background-position: 7px 0
    }

    .question-duoxuan{
        background: url(${staticRoot}/images/piliangshezhi_icon.png) no-repeat;
        background-position: 7px 0
    }

    .question-delete {
        background: url(${staticRoot}/images/shanchu_icon.png) no-repeat;
    ...
    #question_box{border-bottom: 1px solid #dcdcdc;height: calc(100% - 80px); width: calc(100% - 160px);position: fixed;overflow-y: auto;}
    .div-bottom{width: calc(100% - 160px);height: 80px; margin: 0 auto;margin-left: 160px;}
    ...
    .div-radio-img{background: url(${staticRoot}/images/danxuan_btn.png) no-repeat;width: 16px;height: 16px;display: inline-block;position: absolute;top: 7px;}
    .div-checkbox-img{background: url(${staticRoot}/images/weigouxuan_icon.png) no-repeat;width: 16px;height: 16px;display: inline-block;position: absolute;top: 7px;}
    ...
    .div-header-content{font-size: 12px;font-weight: bold;}
    ...
    .div-preview-content{height: 451px;overflow: auto;}
</style>
