            ...
            <div id="dictRetrieve" class="m-retrieve-area f-h50 f-dn f-pr m-form-inline" style="display:block;border: 1px solid #D6D6D6;border-bottom: 0px">
                <div class="m-form-group f-mt10">
                    ...
                    <div class="m-form-control f-mr10 f-fr">
                        <sec:authorize url="/government/createMenu">
                            <div id="div_new_record" class="l-button u-btn u-btn-primary u-btn-small f-ib f-vam"  onclick="javascript:$.publish('government:menuInfo:open',['','new'])">
