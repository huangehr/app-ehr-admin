        ...
        init: function () {
            ...
            this.columns = [
                ...
                {display: '数据集名称', name: 'name', align: 'left', width: '34%'},
                {
                    ...
                    html += "<div class='grid_edit' style='' title='编辑' onclick='set.list.updateSet(\"" + rowdata.id + "\")'></div> ";
                    </sec:authorize>

                    <sec:authorize url="/std/dataset/deleteDataSet">
                    html += "<div class='grid_delete' style=''title='删除' onclick='set.list.deleteSet(\"" + rowdata.id + "\")'></div>";
                    </sec:authorize>
                    return html;
                }
                }
            ...
            this.elementColumns = [
                ...
                {display: '检验字典', name: 'dictName', align: 'left', width: '20%'},
                {
                    ...
                    html +=  "<a class='grid_delete' href='#' onclick='set.list.deleteElement(\"" + rowdata.id + "\")'></a>";
                    </sec:authorize>
                    return html;
                }
                }
