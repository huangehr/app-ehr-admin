...
<script type="text/javascript">
    ...
    (function ($, win) {
        ...
        var urls = {
            update: "${contextRoot}/orgResource/grant/saveMeta"
        }
        var model = ${model};
        var mode = '${mode}';
        var validator;
        ...
        var initBtn = function () {
            ...
            $('#btn_save').click(function () {
                ...
                var params = {dimensionValue: JSON.stringify(dimension), id: model.id, organizationResourceId: model.organizationResourceId, resourceMetadataName: model.resourceMetadataName,
                    resourceMetadataId: model.resourceMetadataId, organizationId: model.organizationId, dimensionId: model.dimensionId, valid: model.valid};
                debugger;
