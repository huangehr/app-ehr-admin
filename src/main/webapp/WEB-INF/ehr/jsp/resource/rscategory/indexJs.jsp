    ...
    init: function () {
      ...
      this.columns = [
        ...
        },
        {
          ...
          <sec:authorize url="/rscategory/delteCateTypeInfo">
          html += "<a class='grid_delete' title='删除' name='delete_click' style='' onclick='cateType.list.deleted(\"" + rowdata.id + "\")'></a>";
          </sec:authorize>
          return html;
        }
        }
          ...
          if (data != null) {
            ...
            if (_res.successFlg) {
              ...
              $.ligerDialog.alert("保存成功", "提示", "success", function () {
                cateType.list.top.dialog_cateType_detail.close();
              }, null);
            }
            else {
              $.Notice.error(_res.errorMsg);
