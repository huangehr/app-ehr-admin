...
<div id="div_wrapper" class="f-ww" style="height: 100%;height: 500px">
	<!-- ####### 查询条件部分 ####### -->
	<div class="f-ww" >
		<div class="f-w240 f-bd f-of-hd" style="float: left;height: 490px">
			<div class="f-mt10 f-mb10 f-ml10 f-w240">
				<input type="text" id="inp_search" class="f-ml10 f-h28"/>
			</div>
			<!--资源浏览树-->
			<div id="div_resource_browse_tree" style="height: 430px;"></div>
		</div>
		<!--资源浏览详情-->
		<div id="div_resource_browse_msg" class="div-resource-browse" style="height: 490px;">
