...
<div class="hr-body" ms-controller="dataCenter" style="padding-bottom: 15px">
    ...
    <div class="row mg-0 hr-c-top pd-b-15 mg-b-0" id="div1">
        ...
        <div class="hr-chart-top col-sm-8 pd-l-0">
            <div class="charts">
                <div class="hr-tit-con">
        ...
        <div class="hr-chart-top col-sm-12">
            <div class="charts">
                <div class="hr-tit-con">
    ...
    <%--医疗资源库--%>
    <div class="row mg-0 hr-c-top pd-b-15" id="div2">
        <div class="big-tit">
            <div class="big-con">
        ...
        <div class="hr-chart-top col-sm-8 pd-r-0">
            <div class="charts">
                <div class="hr-tit-con">
        ...
        <div class="hr-chart-top col-sm-4 pd-l-0">
            <div class="charts">
                <div class="hr-tit-con">
    ...
    <%--健康档案--%>
    <div class="row mg-0 hr-c-top pd-b-15" id="div3">
        <div class="big-tit">
            <div class="big-con">
                <i class="bt-icon bt-i-three"></i><span class="bt-txt">健康档案</span>
            </div>
        </div>
        <div class="hr-chart-top col-sm-2 pd-r-0">
            <div class="charts">
                <div class="hr-tit-con">
        ...
        <div class="hr-chart-top col-sm-5 pd-l-0">
            <div class="charts">
                <div class="hr-tit-con">
    ...
    <div class="row mg-0 hr-c-top pd-b-15" id="div4">
        <div class="big-tit">
            <div class="big-con">
