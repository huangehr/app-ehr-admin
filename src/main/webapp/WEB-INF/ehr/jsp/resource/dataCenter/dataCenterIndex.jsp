    ...
    <div class="dc-body">
        <div class="dc-left">
            ...
            <div class="dc-big-circle">
                <div class="dc-circle-item item-one active" v-on:click="change(0)">
                    <div class="dc-img1"><img src="${staticRoot}/images/shujuzili_icon.png" alt=""></div>
                    <div class="dc-img dc-icon0 active"><img src="${staticRoot}/images/shujuzili_icon.png" alt=""></div>
                    <div class="dc-label">数据治理</div>
                </div>
                <div class="dc-circle-item item-two" v-on:click="change(1)">
                    <div class="dc-img1"><img src="${staticRoot}/images/shujufenxi_icon.png" alt=""></div>
                    <div class="dc-img dc-icon1"><img src="${staticRoot}/images/shujufenxi_icon.png" alt=""></div>
                    <div class="dc-label">数据分析</div>
                </div>
                <div class="dc-circle-item item-three" v-on:click="change(2)">
                    <div class="dc-img1"><img src="${staticRoot}/images/keshihua_icon.png" alt=""></div>
                    <div class="dc-img dc-icon2"><img src="${staticRoot}/images/keshihua_icon.png" alt=""></div>
                    <div class="dc-label">可视化</div>
                </div>
                <div class="dc-circle-item item-four" v-on:click="change(3)">
                    <div class="dc-img1"><img src="${staticRoot}/images/fenjiguanli_icon.png" alt=""></div>
                    <div class="dc-img dc-icon3"><img src="${staticRoot}/images/fenjiguanli_icon.png" alt=""></div>
        ...
        <div class="dc-right">
            ...
            <div class="dc-item-info fadeInUp">
                ...
                <div class="dc-cj" v-on:click="checkInfo(dataHandle[0].appId, dataHandle[0].menuId)">
                    <div class="dc-cj-left">
                        ...
                        <div class="dc-cj-num" v-text="dataHandle[0].total"></div>
                    </div>
                    <%--图表1--%>
                    <div class="dc-cj-right" id="echart1"></div>
                </div>
                <h4 class="dc-r-titT">数据存储</h4>
                <ul class="dc-cc" v-on:click="checkInfo(dataHandle[1].appId, dataHandle[1].menuId)">
                    <li class="dc-cc-item">
                        <div class="dc-cc-icon jm-icon"></div>
                        <div class="dc-cc-tit">居民建档数</div>
                        <div class="dc-cc-num" v-text="dataHandle[1].view[1][0].patient"></div>
                    </li>
                    <li class="dc-cc-item">
                        <div class="dc-cc-icon yl-icon"></div>
                        <div class="dc-cc-tit">医疗资源建档数</div>
                        <div class="dc-cc-num" v-text="dataHandle[1].view[1][1].medicalResources"></div>
                    </li>
                    <li class="dc-cc-item">
                        <div class="dc-cc-icon jk-icon"></div>
                        <div class="dc-cc-tit">健康档案建档数</div>
                        <div class="dc-cc-num" v-text="dataHandle[1].view[1][2].healthArchive"></div>
                    </li>
                    <li class="dc-cc-item">
                        <div class="dc-cc-icon dz-icon"></div>
                        <div class="dc-cc-tit">电子病历建档数</div>
                        <div class="dc-cc-num" v-text="dataHandle[1].view[1][3].electronicCases"></div>
                    </li>
                </ul>
            </div>
            <!--数据分析-->
            <div class="dc-item-info">
                ...
                <div class="dc-yzczb" v-on:click="checkInfo(dataAnalysis.appId, dataAnalysis.menuId)">
                    <div class="dc-zb-top">
                        <div class="dc-zb-icon"></div>
                        <div class="dc-zb-con">
                            <div class="dc-zb-lab">指标总数</div>
                            <div class="dc-zb-num" v-text="dataAnalysis.total"></div>
                        </div>
                    </div>
                    <%--图表2--%>
                    <div class="dc-zb-bottom" id="echart2"></div>
                </div>
            </div>
            ...
            <div class="dc-item-info">
                ...
                <div class="dc-ksh" v-on:click="checkInfo(dataVisualization[0].appId, dataVisualization[0].menuId)">
                    <div class="dc-ksh-left">
                        <div class="dc-ksh-icon"></div>
                        <div class="dc-ksh-tit">视图总数</div>
                        <div class="sc-ksh-num" v-text="dataVisualization[0].total"></div>
                    </div>
                    <%--图表3--%>
                    <div class="dc-ksh-right" id="echart3"></div>
                </div>
                <h4 class="dc-r-titT">已配置资源报表</h4>
                <div class="dc-ksh" v-on:click="checkInfo(dataVisualization[1].appId, dataVisualization[1].menuId)">
                    <div class="dc-ksh-left">
                        <div class="dc-ksh-icon zybb-icon"></div>
                        <div class="dc-ksh-tit">资源报表总数</div>
                        <div class="sc-ksh-num" v-text="dataVisualization[1].total"></div>
                    </div>
                    <%--图表4--%>
                    <div class="dc-ksh-right" id="echart4"></div>
                </div>
            </div>
