...
<!--#####Title设置#####-->
<div class="f-dn" data-head-title="true">指标字典</div>
<div id="div_wrapper">
    <!--#########查询部分##&ndash-->
    <div class="m-retrieve-area f-h50 f-pr m-form-inline" data-role-form>
        <div class="m-form-group f-mt10">
            ...
            <div class="m-form-control f-ml20">
                <sec:authorize url="/specialdict/indicator/update">
            ...
            <div class="m-form-control m-form-control-fr">
                <sec:authorize url="/specialdict/indicator/deletes">
    ...
    <!--###CDA版本信息表###-->
    <div id="div-special-dict-grid"></div>
</div>
