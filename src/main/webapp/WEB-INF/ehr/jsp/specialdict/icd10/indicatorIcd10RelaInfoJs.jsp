	...
	(function($,win){
		$(function(){
			...
			masters = {
				infoDialog:null,
				init:function(){
					infoGrid = $('#div_indicator_include_grid').ligerGrid($.LigerGridEx.config({
						url: '${contextRoot}/specialdict/icd10/indicators/include',
						parms: {
							searchNm: '',
							icd10Id:icd10Id,
							page:0,
				...
				bindEvents: function(){
					...
					$('#btn_relation_deletes').click(function(){
						$.publish("icd10:indicator:delete",[''])
					});

					$.subscribe("icd10:indicator:delete",function(event,ids){
						if(!ids){
						...
						dataModel.createRemote("${contextRoot}/specialdict/icd10/indicator/deletes",{
					...
					$('#btn_relation_new').click(function(){
						...
						masters.createRelationDialog = $.ligerDialog.open({
							...
							width:700,
							title:title,
							url:'${contextRoot}/specialdict/icd10/indicatorRelation/initial',
							urlParms:{
								id:icd10Id
							},
							isHidden: false,
