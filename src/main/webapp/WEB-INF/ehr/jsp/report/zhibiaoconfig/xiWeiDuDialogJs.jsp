...
//                this.initDDL(DimensionSlaveId,this.$inpType,"");
            ...
            getTjDimensionMainByID:function(){
                ...
                dataModel.fetchRemote("${contextRoot}/tjDimensionSlave/getTjDimensionSlaveById", {
            ...
            bindEvents: function () {
                ...
                var validator =  new jValidation.Validation(this.$form, {immediate: true, onSubmit: false,onElementValidateForAjax:function(elm){
                    if(Util.isStrEquals($(elm).attr('id'),'inp_code')){
                        ...
                        var dataModel = $.DataModel.init();
                        dataModel.fetchRemote("${contextRoot}/tjDimensionSlave/isCodeExists", {
                            data: {code:code},
                            async: false,
                            success: function (data) {
                                if (!data) {
                    ...
                    if(Util.isStrEquals($(elm).attr('id'),'inp_name')){
                        ...
                        var dataModel = $.DataModel.init();
                        dataModel.fetchRemote("${contextRoot}/tjDimensionSlave/isNameExists", {
                            data: {name:name},
                            async: false,
                            success: function (data) {
                                if (!data) {
