    ...
    (function ($, win) {
        ...
        weiduInfo = {
            ...
            initForm: function () {
                ...
                this.initDDL(DataStorageId,this.$inpType,"");
            ...
            getTjDimensionMainByID:function(){
                ...
                dataModel.fetchRemote("${contextRoot}/tjDataSave/getTjDataSaveById", {
                    ...
                    success: function (data) {
                        if(data){
                            ...
                            self.initDDL(DataStorageId,self.$inpType,data.type);
            ...
            bindEvents: function () {
                ...
                var validator =  new jValidation.Validation(this.$form, {immediate: true, onSubmit: false,onElementValidateForAjax:function(elm){
                    if(Util.isStrEquals($(elm).attr('id'),'inp_code')){
                        ...
                        var dataModel = $.DataModel.init();
                        dataModel.fetchRemote("${contextRoot}/tjDataSave/hasExistsCode", {
                            data: {code:code},
                            async: false,
                            success: function (data) {
                                if (!data) {
                ...
                self.$updateBtn.click(function(){
                    if(validator.validate()){
                        ...
                        var dataModel = $.DataModel.init();
                        dataModel.fetchRemote("${contextRoot}/tjDataSave/updateTjDataSave", {
                            data: {tjDataSaveModelJsonData:JSON.stringify(values)},
                            async: false,
                            success: function (data) {
                                if (data.successFlg) {
