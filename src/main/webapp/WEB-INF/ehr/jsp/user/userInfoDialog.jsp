...
<%--    <input data-attr-scan="idCardCopy" hidden="hidden" id="idCardCopy"/>
	...
	<div class="m-form-group" >
		...
		<div id="roleDiv" class="l-text-wrapper m-form-control essential">
			<input type="text" id="jryycyc" class="required useTitle f-h28 f-w240 f-dn" required-title=<spring:message code="lbl.must.input"/> data-type="select" placeholder="" data-attr-scan="role">
		</div>
	</div>
