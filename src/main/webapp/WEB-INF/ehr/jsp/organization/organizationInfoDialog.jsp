...
<div class="content-main">
    ...
    <div id="div_organization_info_form" class="m-form-inline" data-role-form="">
        ...
        <div>
            <h3 class="list-tit">基本信息<a href="javascript:;">-</a></h3>
            <div class="list-con">
                <ul class="list-item">
                    <li>
                ...
                <ul class="list-item">
                    <li>
                        <div class="m-form-group">
                            ...
                            <div class="l-text-wrapper m-form-control">
                                <textarea id="tags" class=" max-length-100 validate-special-char one-text-a" placeholder="多个标签，请用分号隔开" data-attr-scan="tags"/>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div>
            <h3 class="list-tit">地区信息<a href="javascript:;">-</a></h3>
            <div class="list-con">
                <ul class="list-item">
                    <li>
                        <div class="m-form-group">
        ...
        <div>
            <h3 class="list-tit">医院信息<a href="javascript:;">-</a></h3>
            <div class="list-con">
                <ul class="list-item">
                    <li>
                        <div class="m-form-group">
