...
//			var resourceId = dataModel.resourceId;
			var orgBackId = dataModel.orgCode;
			var orgRsId = '${orgRsId}';
			var initSub = function (){
				$('#btn_back').click(function(){
					$('#contentPage').empty();
					$('#contentPage').load('${contextRoot}/organization/resource/initial?backParams='+JSON.stringify(dataModel.backParams));
				});
			...
			var em = {
				...
				urls: {
					list: '${contextRoot}/orgResource/grant/list',
					gotoModify: '${contextRoot}/orgResource/grant/gotoMetaGrant',
					lock: '${contextRoot}/orgResource/grant/orgLock'
				},
				//初始化
				init: function(){
					var m = this;
