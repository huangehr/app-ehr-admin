...
<div id="div_cards_info_form" data-role-form class="m-form-inline f-mt20 " data-role-form>
	...
	<div class="m-form-group">
		<label >持卡人身份证:</label>
		<div class="l-text-wrapper m-form-control">
			<input type="text" id="inp_ownerIdcard" class="f-h28 f-w240"  data-attr-scan="ownerIdcard">
		</div>
	</div>
	...
	<div class="m-form-group">
		<label >持卡人绑定手机:</label>
		<div class="l-text-wrapper m-form-control">
			<input type="text" id="inp_ownerPhone" class="f-h28 f-w240"  data-attr-scan="ownerPhone">
		</div>
	</div>
